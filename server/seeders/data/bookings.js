...
const units = [
  ...
  { id: 2, name: "Mitsubishi MUZ-AP60VG2 + MSZ-AP60VGK2 Kompakt 6.1 kW", price: 720800 },
...
const generateBooking = (customers, technicians, year) => {
  ...
  booking.price = calculatePrice(serviceType, booking.unit, booking.maintenancePlan);
  
  booking.description = generateBookingDescription(serviceType, booking.unit, booking.maintenancePlan);
