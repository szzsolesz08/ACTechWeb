  ...
  const fetchBookings = async () => {
    try {
      ...
      const myBookings = (response.bookings || []).filter(booking => {
        ...
        const assignedTechId = booking.assignedTechnician._id?.toString() || booking.assignedTechnician.id?.toString();
        const userId = currentUserId?.toString();
        console.log('Comparing booking', booking.referenceNumber, ':', assignedTechId, 'with', userId, '=', assignedTechId === userId);
  ...
  return (
    <div className="technician-bookings-page">
      <div className="technician-header">
        ...
        <p>Welcome back, {currentUser?.firstName}! Here are your scheduled jobs.</p>
      </div>
